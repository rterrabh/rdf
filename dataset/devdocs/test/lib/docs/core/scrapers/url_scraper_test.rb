...
class DocsUrlScraperTest < MiniTest::Spec
  ...
  describe "#request_one" do
    let :result do
      #nodyna <send-2725> <not yet classified>
  ...
  describe "#request_all" do
    ...
    let :result do
      #nodyna <send-2726> <not yet classified>
