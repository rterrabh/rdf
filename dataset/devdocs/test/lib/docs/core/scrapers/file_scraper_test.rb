...
class FileScraperTest < MiniTest::Spec
  ...
  describe "#request_one" do
    ...
    let :result do
      #nodyna <send-2717> <SD EASY (private methods)>
  ...
  describe "#request_all" do
    ...
    it "requests the given url" do
      ...
      #nodyna <send-2718> <SD EASY (private methods)>
    ...
    it "requests the given urls" do
      ...
      #nodyna <send-2719> <SD EASY (private methods)>
    ...
    it "yields the responses" do
      ...
      #nodyna <send-2720> <SD EASY (private methods)>
    ...
    context "when the block returns an array" do
      ...
      it "requests the returned urls" do
        ...
        #nodyna <send-2721> <SD EASY (private methods)>
      ...
      it "yields their responses" do
        ...
        #nodyna <send-2722> <SD EASY (private methods)>
  ...
  describe "#process_response?" do
    let :result do
      #nodyna <send-2723> <SD EASY (private methods)>
  ...
  describe "#read_file" do
    let :result do
      #nodyna <send-2724> <SD EASY (private methods)>
