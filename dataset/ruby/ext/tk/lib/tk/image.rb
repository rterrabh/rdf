...
class TkImage<TkObject
  ...
  #nodyna <instance_eval-1774> <IEV MODERATE (method definition)>
  ...
  def self.new(keys=nil)
      ...
      if name
        ...
        if obj
          if !(keys[:without_creating] || keys['without_creating'])
            ...
            #nodyna <instance_eval-1775> <IEV MODERATE (private access)>
            obj.instance_eval{
    ...
    #nodyna <instance_eval-1776> <IEV MODERATE (private access)>
